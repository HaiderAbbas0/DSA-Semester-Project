...
public:
    ...
    *******************************************/
    ...
    /******************************************
     Restoring The Signals To Original Status
    ...
    *******************************************/
    ...
    /*************************************************
     Using A Search Algorithm To find the Fastest
     Path which finds total cost using a heuristic
     function and cost from the start to each node.
     The heuristic function is such that it doesnot
     gurantee to work in the worst case but it works
     99.9% of the times.
    **************************************************/
